...
namespace {
    ...
    // Helper function: Calculate element volume
    ...
    // Helper function: Form B matrix (6x24)
    Eigen::Matrix<double, 6, 24> form_b_matrix(
    ...
    for (auto element_entity : element_view) {
        ...
        for (size_t i = 0; i < 8; ++i) {
            ...
            if (registry.all_of<Component::InitialPosition>(node_entity)) {
                ...
                // If no initial position, use current as initial (undeformed)
        ...
        // Calculate displacement vector (current - initial)
        ...
        // Calculate B-bar matrix using current coordinates
        ...
        // Compute element internal forces: f_int = B^T * σ * V
